...
- **Execution probes (cheap)** — one action, real side effect, objective assertion. "Retire script B for A" → is B deleted? is `scripts/README.md` updated? One turn, no simulated chat.
