...
| `upgrade-log.md` | Adoption ledger (created in cloned instances, not the template). Agent-to-agent provenance of which template patterns this instance adopted, adapted, or skipped — and why. Maintained by `/upgrade`. |
